...
Overview
E-Wallet is a microservices-based digital wallet application built with Java. The system is composed of multiple services handling user management, authentication, and financial transactions.
...
Combine phoneNo and password with a colon: phoneNo:password
...
Passwords: Should meet minimum complexity requirements (not specified)
OTP: Time-limited (expiration not specified)
Basic Auth: Should only be used over HTTPS in production
Identity Verification: Requires valid government-issued ID
Technology Stack
Language: Java
...
Repository: https://github.com/nandanraghu276/E-wallet-system
